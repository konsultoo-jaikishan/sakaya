...
class StockPicking(models.Model):
    ...
    shipengine_label_id = fields.Char(string="Ship Engine Label ID", help="Ship Engine Label ID", readonly=True, copy=False)
    shipengine_shipment_id = fields.Char(string="Ship Engine Shipment ID", help="Ship Engine Shipment ID", readonly=True, copy=False)
    shipengine_bill_to_account = fields.Char(string="Shipengine Bill To Account", help="This field is used to bill shipping costs to a third party. This field must be used in conjunction with the bill_to_country_code, bill_to_party, and bill_to_postal_code fields.", copy=False)
    ...
    def get_shipengine_response_data(self, shipper_address=False, recipient_address=False,  total_bulk_weight=False, packages=False,shipengine_bill_to_account=False):
        api_name = 'rates'
    ...
    def generate_shipengine_rate(self):
        try:
            ...
            res = self.get_shipengine_response_data(shipper_address, receipient_address, total_bulk_weight, packages=packages,
